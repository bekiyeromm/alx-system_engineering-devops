...
[PEP8 Python style - having a clean code respecting style guide is really appreciated in the industry](https://peps.python.org/pep-0008/)<br>
### Learning Objectives
...
Directory: 0x15-api<br>
File: 0-gather_data_from_an_API.py<br>
